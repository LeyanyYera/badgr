...
DATABASES = {
    'default': {
        ...
        'USER': 'badgr',                      # Not used with sqlite3.
        'PASSWORD': 'badgr',                  # Not used with sqlite3.
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'medallas@ceibal.edu.uy'
EMAIL_HOST_PASSWORD = 'badgr123ceibal'
EMAIL_SUBJECT_PREFIX = 'Medallas - Plan Ceibal'
EMAIL_USE_TLS = True
EMAIL_SSL_CERTFILE = '/etc/ssl/certs/ca-certificates.crt'
...
DEFAULT_FROM_EMAIL = 'medallas@ceibal.edu.uy'
