...
class LocalFamilyClass(AbstractFamilyClass):
...
class LocalCategoryClass(AbstractCategoryClass):
    family = models.ForeignKey(LocalFamilyClass, blank=False, null=False,
                               on_delete=models.PROTECT,
